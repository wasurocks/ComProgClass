public class MyDate {
	...
	private int month;
	private int day;
	private static final String[] strMonths = new String[] {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
	private static final String[] strDays = new String[] {"Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"};
	...
	public static boolean isValidDate(int year, int month, int day) {
		return (year > 0 && year < 10000) 
			&& (month > 0 && month < 13) 
			&& (day > 0 
				&& day < ((month == 2 && MyDate.isLeapYear(year))? 29 : MyDate.daysInMonths[month - 1]) + 1);	
	}
	...
	public void setDate(int year, int month, int day) {
		if(!MyDate.isValidDate(year, month, day)) System.out.println("Invalid year, month, or day!");
		else {
			this.year = year;
			this.month = month;
			this.day = day;
	...
	public String toString() {
		return MyDate.strDays[
			MyDate.getDayOfWeek(this.year, this.month, this.day)] 
		+ " " + getDay() 
		+ " " + MyDate.strMonths[getMonth() - 1] 
		+ " " + getYear();
	}
